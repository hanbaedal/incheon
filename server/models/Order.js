...
const orderItemSchema = new mongoose.Schema(
  {
    itemType: { type: String, enum: ["product", "coffin", "hoengdae", "shroud", "accessory", "foodItem", "flowerItem", "photoItem", "dressItem", "hearseItem", "servicePrice", "hall"], default: "product" },
