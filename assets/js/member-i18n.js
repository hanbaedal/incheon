...
(function () {
  ...
  const M = {
    ...
    "nav.shop": { ko: "장례예약", zh: "殡葬预约", en: "Reservations" },
    "nav.orders": { ko: "내 예약", zh: "我的预约", en: "My Orders" },
    "nav.guide": { ko: "장례안내", zh: "殡葬指南", en: "Funeral Guide" },
    ...
    "shop.tabObituary": { ko: "신문 부고 안내", zh: "报纸讣告", en: "Obituary" },

    "guide.pageTitle": { ko: "장례안내 | 상주 전용 서비스", zh: "殡葬指南 | 丧主专用服务", en: "Funeral Guide | Family Portal" },
    "guide.title": { ko: "장례 안내", zh: "殡葬指南", en: "Funeral guide" },
    "guide.lead": { ko: "관련서식 다운로드, 장사시설 안내, 신문 부고 작성 방법을 확인하실 수 있습니다.", zh: "可下载相关表格、查看殡葬设施指南及报纸讣告撰写方法。", en: "Download forms, view facility information, and obituary guidance." },
    ...
    "info.formsNote": { ko: "서식 파일은 관리자가 등록하면 즉시 다운로드할 수 있습니다. 문의: <b>032-524-4444</b>", zh: "管理员登记表格文件后即可下载。咨询：<b>032-524-4444</b>", en: "Forms are available for download once registered by staff. Contact: <b>032-524-4444</b>" },
    ...
    "info.obituaryLead": { ko: "신문 부고 게재 절차와 문안 작성 방법을 안내합니다.", zh: "介绍报纸讣告的刊登流程与文案撰写方法。", en: "How to place a newspaper obituary and write the text." },
    "info.obituaryStepsTitle": { ko: "부고 게재 절차", zh: "讣告刊登流程", en: "Publication steps" },
    "info.obituaryStep1": { ko: "문안 작성", zh: "撰写文案", en: "Write the text" },
    "info.obituaryStep1d": { ko: "고인·상주·발인 정보를 정리", zh: "整理逝者·丧主·出殡信息", en: "Organize deceased, mourner, and procession info" },
    "info.obituaryStep2": { ko: "매체 선택", zh: "选择媒体", en: "Choose media" },
    "info.obituaryStep2d": { ko: "중앙지/지방지 등 게재 신문 선택", zh: "选择中央报/地方报等刊登报纸", en: "Select national or local newspapers" },
    "info.obituaryStep3": { ko: "접수 · 확인", zh: "受理·确认", en: "Submit and confirm" },
    "info.obituaryStep3d": { ko: "마감 시간 내 접수, 문안·게재일 확인", zh: "截稿前受理，确认文案·刊登日", en: "Submit before deadline; confirm text and date" },
    "info.obituaryStep4": { ko: "게재", zh: "刊登", en: "Publish" },
    "info.obituaryStep4d": { ko: "지정일 신문에 부고 게재", zh: "于指定日报纸刊登讣告", en: "Obituary appears on the chosen date" },
    "info.obituarySampleTitle": { ko: "부고 문안 예시", zh: "讣告文案示例", en: "Obituary example" },
    "info.obituarySample": { ko: "故 ○○○ 님께서 별세하셨기에 삼가 알려드립니다.", zh: "谨讣告：故 ○○○ 先生/女士 逝世。", en: "We solemnly announce the passing of the late ○○○." },
    "info.obituarySampleHall": { ko: "· 빈소 : 근로복지공단 인천병원 장례식장 특실 1호", zh: "· 灵堂 : 劳动福祉公团仁川医院殡仪馆 特室1号", en: "· Hall : KCOMWEL Incheon Hospital Funeral Hall, Premium 1" },
    "info.obituarySampleDate": { ko: "· 발인 : 2026년 ○월 ○일 오전 ○시", zh: "· 出殡 : 2026年○月○日 上午○时", en: "· Procession : 2026. ○. ○, ○ AM" },
    "info.obituarySampleSite": { ko: "· 장지 : ○○○", zh: "· 葬地 : ○○○", en: "· Burial site : ○○○" },
    "info.obituarySampleChief": { ko: "· 상주 : 자녀 ○○○, ○○○", zh: "· 丧主 : 子女 ○○○、○○○", en: "· Mourners : children ○○○, ○○○" },
    ...
    "prod.facilityHead": { ko: "시설 사용료", zh: "设施使用费", en: "Facility Fees" },
    "prod.facilityLead": { ko: "안치료·입관실 등 시설 사용료를 일수만큼 선택해 청구합니다.", zh: "按天数选择安置费、入殓室等设施使用费进行结算。", en: "Select facility fees such as enshrinement and preparation room by number of days." },
